...
;
DELETE FROM "ATLAS"."RESULTS"."temp69208_chrt0" where cohort_definition_id = 1;
INSERT INTO "ATLAS"."RESULTS"."temp69208_chrt0" (cohort_definition_id, subject_id, cohort_start_date, cohort_end_date)
select 1 as cohort_definition_id, person_id, start_date, end_date 
FROM final_cohort CO
;
-- BEGIN: Censored Stats
delete from "ATLAS"."RESULTS"."temp69208_chrt0_censor_stats" where cohort_definition_id = 1;
-- END: Censored Stats
...
delete from "ATLAS"."RESULTS"."temp69208_chrt0_inclusion_result" where cohort_definition_id = 1 and mode_id = 0;
insert into "ATLAS"."RESULTS"."temp69208_chrt0_inclusion_result" (cohort_definition_id, inclusion_rule_mask, person_count, mode_id)
...
delete from "ATLAS"."RESULTS"."temp69208_chrt0_inclusion"_stats where cohort_definition_id = 1 and mode_id = 0;
insert into "ATLAS"."RESULTS"."temp69208_chrt0_inclusion"_stats (cohort_definition_id, rule_sequence, person_count, gain_count, person_total, mode_id)
...
LEFT JOIN "ATLAS"."RESULTS"."temp69208_chrt0_inclusion_result" SR on SR.mode_id = 0 AND SR.cohort_definition_id = 1 AND (POWER(cast(2 as bigint),RuleTotal.total_rules) - POWER(cast(2 as bigint),ir.rule_sequence) - 1) = SR.inclusion_rule_mask -- POWER(2,rule count) - POWER(2,rule sequence) - 1 is the mask for 'all except this rule'
;
-- calculate totals
delete from "ATLAS"."RESULTS"."temp69208_chrt0_summary_stats" where cohort_definition_id = 1 and mode_id = 0;
insert into "ATLAS"."RESULTS"."temp69208_chrt0_summary_stats" (cohort_definition_id, base_count, final_count, mode_id)
...
(select sum(sr.person_count) as total
  from "ATLAS"."RESULTS"."temp69208_chrt0_inclusion_result" sr
  CROSS JOIN (select count(*) as total_rules from inclusion_rules) RuleTotal
...
-- calculte matching group counts
delete from "ATLAS"."RESULTS"."temp69208_chrt0_inclusion_result" where cohort_definition_id = 1 and mode_id = 1;
insert into "ATLAS"."RESULTS"."temp69208_chrt0_inclusion_result" (cohort_definition_id, inclusion_rule_mask, person_count, mode_id)
...
;
-- calculate gain counts 
delete from "ATLAS"."RESULTS"."temp69208_chrt0_inclusion"_stats where cohort_definition_id = 1 and mode_id = 1;
insert into "ATLAS"."RESULTS"."temp69208_chrt0_inclusion"_stats (cohort_definition_id, rule_sequence, person_count, gain_count, person_total, mode_id)
...
LEFT JOIN "ATLAS"."RESULTS"."temp69208_chrt0_inclusion_result" SR on SR.mode_id = 1 AND SR.cohort_definition_id = 1 AND (POWER(cast(2 as bigint),RuleTotal.total_rules) - POWER(cast(2 as bigint),ir.rule_sequence) - 1) = SR.inclusion_rule_mask -- POWER(2,rule count) - POWER(2,rule sequence) - 1 is the mask for 'all except this rule'
;
-- calculate totals
delete from "ATLAS"."RESULTS"."temp69208_chrt0_summary_stats" where cohort_definition_id = 1 and mode_id = 1;
insert into "ATLAS"."RESULTS"."temp69208_chrt0_summary_stats" (cohort_definition_id, base_count, final_count, mode_id)
