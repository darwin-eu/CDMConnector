...
When generating SQL for multiple ATLAS cohort definitions, the naive approach
...
<div style="text-align:center;">
  <img src="../images/Cohort JSON Processing-2026-02-15-141031.png" style="width:35%;" />
</div>
...
<div style="text-align: center;">
  <img 
    src="../images/Cohort JSON Processing-2026-02-15-141722.png"
...
<div style="text-align: center; width: 50%; margin-left: auto; margin-right: auto;">
  <img src="../images/Cohort JSON Processing-2026-02-15-142734.png" style="max-width: 100%; height: auto;" />
</div>
...
<div style="text-align: center;">
  <img 
    src="../images/Cohort JSON Processing-2026-02-15-142825.png"
    style="max-width: 100%; height: auto; transition: transform 0.25s cubic-bezier(.4,2,.6,1); cursor: zoom-in;"
...
- **`force_full_path` option**: Setting
  `options(atlasCohortGenerator.force_full_path = TRUE)` disables Phase 1
