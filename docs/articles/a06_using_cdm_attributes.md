...
``` r
cdmCon(cdm)
#> <duckdb_connection 92fa0 driver=<duckdb_driver dbdir='/private/var/folders/2j/8z0yfn1j69q8sxjc7vj9yhz40000gp/T/RtmpO84JbJ/file14f4e19ecd08c.duckdb' read_only=FALSE bigint=numeric>>
```
...
#> Rows: ??
#> Columns: 4
#> Database: DuckDB 1.4.4 [root@Darwin 25.2.0:R 4.5.1//private/var/folders/2j/8z0yfn1j69q8sxjc7vj9yhz40000gp/T/RtmpO84JbJ/file14f4e19ecd08c.duckdb]
