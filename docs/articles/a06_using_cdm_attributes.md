...
``` r
cdmCon(cdm)
#> <duckdb_connection 611b0 driver=<duckdb_driver dbdir='/private/var/folders/2j/8z0yfn1j69q8sxjc7vj9yhz40000gp/T/RtmpijcI8m/file137852e3a7887.duckdb' read_only=FALSE bigint=numeric>>
```
...
#> Rows: ??
#> Columns: 4
#> Database: DuckDB 1.4.4 [root@Darwin 25.2.0:R 4.5.1//private/var/folders/2j/8z0yfn1j69q8sxjc7vj9yhz40000gp/T/RtmpijcI8m/file137852e3a7887.duckdb]
