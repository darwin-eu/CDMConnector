...
``` r
cdmCon(cdm)
#> <duckdb_connection 4baf0 driver=<duckdb_driver dbdir='/tmp/RtmpmkTFQE/file254644a8e818.duckdb' read_only=FALSE bigint=numeric>>
```
...
#> Rows: ??
#> Columns: 4
#> Database: DuckDB 1.4.4 [unknown@Linux 6.14.0-1017-azure:R 4.5.2//tmp/RtmpmkTFQE/file254644a8e818.duckdb]
