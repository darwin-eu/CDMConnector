...
delete from "ATLAS"."RESULTS"."temp23019_chrt0_inclusion"_stats where "cohort_definition_id" = 3 and mode_id = 0;
insert into "ATLAS"."RESULTS"."temp23019_chrt0_inclusion"_stats ("cohort_definition_id", rule_sequence, person_count, gain_count, person_total, mode_id)
...
LEFT JOIN "ATLAS"."RESULTS"."temp23019_chrt0_inclusion_result" SR on SR.mode_id = 0 AND SR."cohort_definition_id" = 3 AND (POWER(cast(2 as bigint),RuleTotal.total_rules) - POWER(cast(2 as bigint),ir.rule_sequence) - 1) = SR.inclusion_rule_mask -- POWER(2,rule count) - POWER(2,rule sequence) - 1 is the mask for 'all except this rule'
;
-- calculate totals
...
;
-- calculate gain counts 
delete from "ATLAS"."RESULTS"."temp23019_chrt0_inclusion"_stats where "cohort_definition_id" = 3 and mode_id = 1;
insert into "ATLAS"."RESULTS"."temp23019_chrt0_inclusion"_stats ("cohort_definition_id", rule_sequence, person_count, gain_count, person_total, mode_id)
...
LEFT JOIN "ATLAS"."RESULTS"."temp23019_chrt0_inclusion_result" SR on SR.mode_id = 1 AND SR."cohort_definition_id" = 3 AND (POWER(cast(2 as bigint),RuleTotal.total_rules) - POWER(cast(2 as bigint),ir.rule_sequence) - 1) = SR.inclusion_rule_mask -- POWER(2,rule count) - POWER(2,rule sequence) - 1 is the mask for 'all except this rule'
;
-- calculate totals
