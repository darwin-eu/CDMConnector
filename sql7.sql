...
;
DELETE FROM "ATLAS"."RESULTS"."temp80052_chrt0" where cohort_definition_id = 1;
INSERT INTO "ATLAS"."RESULTS"."temp80052_chrt0" (cohort_definition_id, subject_id, cohort_start_date, cohort_end_date)
select 1 as cohort_definition_id, person_id, start_date, end_date 
FROM final_cohort CO
;
-- BEGIN: Censored Stats
delete from "ATLAS"."RESULTS"."temp80052_chrt0_censor_stats" where cohort_definition_id = 1;
-- END: Censored Stats
